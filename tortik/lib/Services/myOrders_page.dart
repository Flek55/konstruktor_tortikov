...
class MyOrdersPage extends StatefulWidget {
  ...
  const MyOrdersPage(
      {super.key, required this.ordersData, required this.orderIds});
        ...
        itemBuilder: (context, index) {
          return Padding(
              ...
              child: ListTile(
                onTap: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute<void>(
                        builder: (BuildContext context) => OrderProductsPage(
                            data: widget.ordersData[index],
                            id: widget.orderIds[index]),
                      ));
                },
                ...
                title: Text("Заказ №${widget.orderIds[index]}",
                    style: Theme.of(context)
                        .textTheme
                        .displayMedium
